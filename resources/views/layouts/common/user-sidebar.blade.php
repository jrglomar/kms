    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ env('APP_URL') }}/user/users" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ env('APP_URL') }}/user/roles" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ env('APP_URL') }}/user/slideshow_contents" aria-expanded="false">
                        <span>
                            <i class="ti ti-user-plus"></i>
                        </span>
